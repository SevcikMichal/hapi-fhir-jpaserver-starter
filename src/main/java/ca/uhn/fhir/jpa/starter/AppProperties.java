 ...
 public void setIps_enabled(Boolean ips_enabled) {
  ...
  public static class Subscription {
    ...
    public void setWebsocket_enabled(Boolean websocket_enabled) {
	  ...
	  public Boolean getChange_queued_immediately() {
		  return change_queued_immediately;
	  }

	  public void setChange_queued_immediately(Boolean change_queued_immediately) {
		  this.change_queued_immediately = change_queued_immediately;
	  }
